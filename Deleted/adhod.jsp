...
<script type="text/JavaScript" src="js/slimbox2.js"></script> 
    ...
    <script>alert('HOD Added success');</script>
    <%}
...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
        ...
        <div id="templatemo_menu" class="ddsmoothmenu">
            <ul>
                ...
                <li><a href="adhod.jsp" class="selected">Add HOD</a></li>                 
                
                <li><a href="adevent.jsp">Add Event</a></li>
    ...
    <div id="templatemo_main">
            ...
            <center>  <form name="myform" action="adhodact.jsp" method="post">
         <table border="0" >
             <font color="#ff3300" size="5">Add H.O.D</font></h2> 
         <br><br><br>
                     <tr><td><font color="black" size="3"> Hod Name :</td><td><input type="text" name="hod" required="" /></td></tr>
         <tr><td><font color="black" size="3">Password :</td><td><input type="password" name="password" required="" /></td></tr>
         <tr>
          <td><font color="black" size="3">Department</td>   
             <td>
         ...
         <tr><td><font color="black" size="3"> Email :</td><td><input type="email" name="email" required="" /></td></tr>
       
         <tr><td><font color="black" size="3"> Mobile :</td><td><input type="text" name="mobile" required="" /></td></tr>
         
         <tr rowspan="2" align="center"><td><br><input type="submit" name="submit" value="    Add HOD    " /></td></tr>
         <tr></tr>      
         </table>
         </form>
