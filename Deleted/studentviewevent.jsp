...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
        ...
        <div id="templatemo_menu" class="ddsmoothmenu">
            <ul>
                  <li><a href="studenhome.jsp">Home</a></li>
                <li><a href="studentviewevent.jsp"  class="selected">Event</a>  </li>
    ...
    <div id="templatemo_main">
            ...
            <center> 
             ...
             <font color="#ff3300" size="5">View Event</font></h2> 
            <br><br>
                <%
                 String event = session.getAttribute("event").toString();    
         
                Connection con = Dbconnection.getConnection();
                PreparedStatement pst=con.prepareStatement("select * from event where eventname = '"+event+"'");     
