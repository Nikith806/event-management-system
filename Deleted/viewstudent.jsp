...
<script type="text/JavaScript" src="js/slimbox2.js"></script> 
    ...
    <script>alert('Authorized success');</script>
    <%}
...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
        ...
        <div id="templatemo_menu" class="ddsmoothmenu">
            <ul>
                ...
                <li><a href="viewstudent.jsp" class="selected">Student</a></li>                   
    ...
    <div id="templatemo_main">
            ...
            <center> 
             ...
             <font color="#ff3300" size="5">View Student</font></h2> 
            <br><br>
                <%
                ...
                %>
                    ...
                    <table width="80%" border="2">
                      ...
                      <tr style="color:black">
                          ...
                          <th><%=rs.getString("event")%></th>
                          <th><%=rs.getString("status")%></th>
                          
                          <th><a href="accept.jsp?name=<%=rs.getString("name")%>&htno=<%=rs.getString("htno")%>&email=<%=rs.getString("email")%>">Click</a></th>
